...
## Slide 1: Introduction to Spatial Structure in Epidemics
...
## Slide 2: Setting Up the Simulation
...
## Slide 3: Running the Simulation
...
- Note the speed of spread from the starting location.
- Observe the appearance of hotspots and variations in disease dynamics across states.

---

## Slide 4: Analysis of Simulation Outcomes
...
## Slide 5: Using Interactivity to Enhance Understanding
...
- Discuss how the spatial model provides a different perspective on the epidemic compared to the basic SIR model.
