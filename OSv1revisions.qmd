...
-   Parameterize Scenario 2a and 2b .
...
-   Adjust the color display to enhance visibility of infected individuals.
-   Update controls for panning to improve user experience (consider right-click panning or WASD navigation).
